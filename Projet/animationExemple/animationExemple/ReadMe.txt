========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet animationExemple
========================================================================

AppWizard a créé cette application animationExemple pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application animationExemple.


animationExemple.vcxproj
...
animationExemple.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé animationExemple.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
